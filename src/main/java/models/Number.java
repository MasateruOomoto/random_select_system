...
@NamedQueries({
    ...
    @NamedQuery(
            name = JpaConst.Q_NUM_DELETE_BY_CHAPTER_ID,
            query = JpaConst.Q_NUM_INFOMATION_DELETE_BY_CHAPTER_ID),
    @NamedQuery(
            name = JpaConst.Q_NUM_DELETE_BY_WORKBOOK_ID,
            query = JpaConst.Q_NUM_INFOMATION_DELETE_BY_WORKBOOK_ID)
    })
